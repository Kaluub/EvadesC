...
from packer_data import enemy_types, zone_types, textures
...
def are_area_dimensions_shared(area: dict, previous_area: dict) -> bool:
...
def main():
    ...
    out.close()
    print(f"Areas: {total_areas}. Same area shapes: {same_areas}. ({same_areas/total_areas*100:.3f}%)")
